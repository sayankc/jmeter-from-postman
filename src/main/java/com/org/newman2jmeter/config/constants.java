...
public class constants {
	...
	public static final String cacheManagerContent2Replace = "</CookieManager>\n" + 
			"        <hashTree/>";
	
	public static final String cacheManagerDefaultContent =	"</CookieManager>\n" + 
			"        <hashTree/>\n" + 
			...
			"          <intProp name=\"maxSize\">6000</intProp>\n" + 
			"        </CacheManager>\n" + 
			"        <hashTree/>";
	public static final String dataSetContent2Replace = "</CacheManager>\n" + 
			"        <hashTree/>";
	
	public static final String dataSetDefaultContent =	"</CacheManager>\n" + 
			"        <hashTree/>\n" + 
			"        <CSVDataSet guiclass=\"TestBeanGUI\" testclass=\"CSVDataSet\" testname=\"Data Set Config\" enabled=\"false\">\n" + 
			"          <stringProp name=\"filename\">your_test_data_file_to_be_changed.csv</stringProp>\n" + 
