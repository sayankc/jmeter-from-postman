...
import com.org.newman2jmeter.config.newman2jmeterConfig;
import com.org.newman2jmeter.exception.NoPostmanCollectionItemException;
import com.org.newman2jmeter.exception.NullPostmanCollectionException;
import com.org.newman2jmeter.model.jmx.*;
...
public abstract class AbstractJmxFileBuilder implements IJmxFileBuilder {
    ...
    protected JmxFile buildJmxFile(PostmanCollection postmanCollection, String jmxOutputFilePath) throws Exception {
        ...
        newman2jmeterConfig config = new newman2jmeterConfig();
